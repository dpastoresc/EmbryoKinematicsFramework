    ...
    for DescriptorIndex=DescriptorsIndexes
        ...
        for idN=1:length(dNs)
            ...
            if idN==1
                ...
                plot(Basis')
                ylim([0 limy(ic)])
                saveas(h,[StatsPath dataset tagfolder filesep 'plot_CLBPs_template_' '-' tagDesc '.png'],'png')
                ...
                plot(Basis')
                ylim([0 limy(ic)])
                saveas(h,[StatsPath dataset tagfolder filesep 'plot_CLBPs_' '-' tagDesc '.png'],'png')
