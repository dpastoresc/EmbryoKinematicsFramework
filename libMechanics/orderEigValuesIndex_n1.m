...
function evalues=orderEigValuesIndex_n1(evalin)
...
if size(iothers,2)>0
    ...
    ie2=find(aeig==e2);
    offset=length(ie1)+1;
    evalues(1,offset:offset+length(ie2)-1)=ie2;    
    ...
    if offset<3
       ...
       offset=offset+1;
       ie3=find(aeig==e3);
       evalues(offset:offset+length(e3)-1)=ie3;
    end
end
