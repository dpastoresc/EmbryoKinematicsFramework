...
%Attention: this version 2 includes X value for gradient spatial scale

function ch2_call_MovStrainCalc_dav2(dataset, savepath, tscale,Xscale,Rscale,radialCorrection, spatialAve,X,maxNeigh,minNeigh, onlySimilar, tini, tfinal)   
...
for t=tList
    ...
    [MovAux MeanMovAux TenseurGradAux NeighAux] = ch2_MovStrainCalc2_dav(datas,t,params,my_flags);
    Mov{t} = MovAux;
