...
s_yl=[0.2 0.1 0.25 0.005 0.005; 1 0.5 1 0.005 0.005; 1 0.5 1 0.005 0.005; 20 15 25 0.005 0.005]
...
for DescriptorsSet=DescriptorsSets
    for DescriptorIndex=DescriptorsIndexes
        ...
        for idN=1:length(dNs)
            ...
            D=dlmread([desc 'score' '-' tagDesc '_v2.csv'])
            ...
            ylabel('Distance to CLPB','FontSize',16)
            ylim([0 s_yl(c,s_mi)])
            ...
            grid on
            [StatsPath dataset tagfolder filesep 'plot_score' '-' tagDesc '-' s_metric(s_mi) '.png']
            saveas(h,[StatsPath dataset tagfolder filesep 'plot_score' '-' tagDesc '-' s_metric{s_mi} '.png'],'png')
