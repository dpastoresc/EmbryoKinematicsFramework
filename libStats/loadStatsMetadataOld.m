...
elseif DescriptorsSet==5
    ...
    tagsCmaps={'FTLE','FTLEisochoric','Speed Lagrangian','Topology','J','MIC1','MIC2','Rotation','MaxShear','IntermediateShear','e1','e2','e3'}
    tags={'FTLE','FTLEisochoric','Speed Lagrangian','Topology','J','MIC1','MIC2','\theta','MaxShear','IntermediateShear','e1','e2','e3'}
    if useDefault
        tagsShort={'FTLE','FTLEiso','SpeedLag','Topo','J','MIC1','MIC2','\theta','Shear1','Shear2','e1','e2','e3'}
    else
        tagsShort={'FTLE','FTLEiso','SpeedLag','Topo','J','M1','M2','\theta','S1','S2','e1','e2','e3'}
    end
    index=[7 8 9 10 11 12 13 14 30 31 18 22 26]
    if doCluster || doProfile || doBasis || doProjection
